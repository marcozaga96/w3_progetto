...
public class Prestito {
    ...
    public Prestito(Utente utente, ElementoDelCatalogo elementoPrestato, LocalDate dataInizioPrestito, LocalDate dataRestituzionePrevista, LocalDate dataRestituzioneEffettiva) {
        this.utente = utente;
